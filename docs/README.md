...
### ✅ 관리자 모드 진입 기능
- [x] 상품 번호 입력에 `12345`를 입력시 관리자 모드로 진입한다
- [x] 관리자 메뉴 선택 안내 메시지를 출력한다

### ✅ 상품 추가(관리자) 기능
- [x] 상품 정보 입력 안내 메시지를 출력한다
- [x] 입력된 상품을 파싱한 후 추가한다
- [x] 추가된 상품은 가장 마지막 상품의 1 증가된 번호를 부여받는다
- [x] `예외처리` 잘못된 입력인 경우 예외가 발생한다

### ✅ 통계 조회(관리자) 기능
- [x] 상품 목록과 판매 갯수를 출력한다
- [x] 총 매출을 계산해 출력한다
- [x] 현재 현금 잔고를 출력한다
